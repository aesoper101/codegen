...
func (arg *Argument) Parse(c *pflag.FlagSet, cmd string) (*Argument, error) {
...
func (arg *Argument) parseStringSlice(c *pflag.FlagSet) {
	arg.IdlPaths, _ = c.GetStringSlice("idl")
	arg.Includes, _ = c.GetStringSlice("proto_path")
	arg.Excludes, _ = c.GetStringSlice("exclude_file")
	arg.RawOptPkg, _ = c.GetStringSlice("option_package")
	arg.ThriftOptions, _ = c.GetStringSlice("thriftgo")
	arg.ProtocOptions, _ = c.GetStringSlice("protoc")
	arg.ThriftPlugins, _ = c.GetStringSlice("thrift-plugins")
	arg.ProtobufPlugins, _ = c.GetStringSlice("protoc-plugins")
	arg.RmTags, _ = c.GetStringSlice("rm_tag")
}
