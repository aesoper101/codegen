...
func newThriftIDLCache(cu *golang.CodeUtils) *IDLCache {
	return &IDLCache{
...
func (c *IDLCache) deepAdd(astFile *parser.Thrift) (*golang.Scope, error) {
...
func (c *IDLCache) add(ast *parser.Thrift) (*golang.Scope, error) {
	path := ast.GetFilename()
